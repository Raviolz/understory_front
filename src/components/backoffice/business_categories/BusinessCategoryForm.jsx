...
function BusinessCategoryForm({ initialValues = emptyForm, submitLabel, onSubmit, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-8 max-w-3xl rounded-2xl border border-border-soft bg-surface p-6">
      ...
      <p className="mt-3 text-sm leading-6 text-muted">Crea o modifica una categoria usata per classificare le attività locali.</p>
